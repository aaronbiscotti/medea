...
export default function CourseDescription() {
    return (
        <div className="flex">
            ...
            <div className="max-w-7xl mx-auto px-4 space-y-8 mt-20 sm:px-6 lg:px-8 flex-1">
                <div className="text-base max-w-prose mx-auto lg:max-w-none">
                    <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase">Course Description</h2>
                        ...
                        <blockquote className="relative bg-white rounded-lg shadow-lg">
                            ...
                            <cite className="relative flex items-center sm:items-start bg-blue-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                                <span className="relative ml-4 text-blue-300 font-semibold leading-6 sm:ml-24 sm:pl-1">
                                    <p className="text-white font-semibold sm:inline">Jeffrey Li</p>{' '}
                                    <p className="sm:inline">Bronx Science '23</p>
                                </span>
                            </cite>
                        </blockquote>
                    </div>
